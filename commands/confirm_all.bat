...
"%PYTHON_EXE%" "%PROJECT_ROOT%\scripts\commands\run_companies.py" --jobs-config "%COMPANY_CONFIG%" --month "%RUN_MONTH%" --allow-confirm --allow-cross-entity-confirm
...
echo Example: commands\confirm_all.bat company_20151038_ÐÇº£¹«Ë¾ 2026-08
exit /b 2

...
"%PYTHON_EXE%" "%PROJECT_ROOT%\scripts\commands\verify_bank_receipts.py" --config "%COMPANY_CONFIG%" --month "%RUN_MONTH%"
exit /b %ERRORLEVEL%

:usage
echo Usage: commands\verify_bank.bat COMPANY_CONFIG_NAME YYYY-MM
echo Example: commands\verify_bank.bat company_17867515_上海微誉信息技术有限公司 2026-07
exit /b 2

...
echo This will upload ONE receipt: %COMPANY_CONFIG_NAME% / %RUN_MONTH%
set /p "CONFIRM_KEY=Type %COMPANY_CONFIG_NAME% %RUN_MONTH% to continue: "
if /i not "%CONFIRM_KEY%"=="%COMPANY_CONFIG_NAME% %RUN_MONTH%" (
  echo Cancelled.
  exit /b 2
)
...
:usage
echo Usage: commands\confirm_one.bat COMPANY_CONFIG_NAME YYYY-MM
echo Example: commands\confirm_one.bat company_20151038_ÐÇº£¹«Ë¾ 2026-08
exit /b 2

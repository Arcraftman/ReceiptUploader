...
"%PYTHON_EXE%" "%PROJECT_ROOT%\scripts\commands\list_bank_exceptions.py" --config "%COMPANY_CONFIG%" --month "%RUN_MONTH%"
exit /b %ERRORLEVEL%

:usage
echo Usage: commands\list_bank_exceptions.bat COMPANY_CONFIG_NAME YYYY-MM
echo Example: commands\list_bank_exceptions.bat company_17867515_上海微誉信息技术有限公司 2026-07
exit /b 2

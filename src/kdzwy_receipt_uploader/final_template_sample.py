"""Build the final Qwen filling sample with runtime account-book catalogs."""
...
def load_final_template_sample(path: Path) -> dict[str, Any]:
    """Load the sample owned by the explicitly selected template company."""
